...
var i = 2;
function switchTAB() {
	var x = document.getElementById("nav-item-switch");
	if(i%2 == 0) {
		document.getElementById("nav-item-switch").style= "display: grid; height: 50vh; margin-left: 5%;";
		document.getElementById("search-switch").style= "display: block; margin-left: 5%;";
	}else {
		document.getElementById("nav-item-switch").style= "display: none;";
...
const root = documrnt.documentElement;
